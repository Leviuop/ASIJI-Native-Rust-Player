...
В версии 0.6.0 можно перетащить аудио/видео в меню терминала и нажать Enter:
файлы копируются в медиатеку, исходники сохраняются, существующие файлы не
перезаписываются. Поддерживаются Windows и Linux, несколько путей и пробелы.
Настройки GPU, диагностика и установщики из 0.5.0 сохранены.
