...
Исправлена комплектность лицензий: в пакеты добавлены уведомления стандартной
библиотеки Rust, сведения о компиляторе и машиночитаемый список зависимостей.
Упаковка проверяет лицензии для целевой платформы, обязательные уведомления
и целостность полных MPL-исходников. Воспроизведение не изменялось.

[Права использования и распространения](https://github.com/Leviuop/ASIJI-Native-Rust-Player/blob/main/docs/LICENSING.md)
описывают также FFmpeg, Windows runtime, иллюстрации и границы проверки.
...
- **Linux x64, glibc 2.35+:** установите FFmpeg и ALSA, распакуйте tar.gz,
  запустите `./start.sh`.
- **Debian 12+ / Ubuntu 22.04+:** `sudo apt install ./asiji_0.8.1_amd64.deb`, затем `asiji`.
