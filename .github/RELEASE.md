...
В версии 0.5.0 добавлены VAAPI для Linux, выбор GPU, переход на CPU при ошибках,
`--doctor` и установка в каталог пользователя (`install.bat` / `bash install.sh`).
TOML-настройки и бинды работают на обеих системах.
