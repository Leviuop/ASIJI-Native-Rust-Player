...
На Windows доступен экспериментальный режим [живых обоев](WALLPAPER.md):
в настройках включите «Живые обои (Windows)», сохраните и выберите трек.
В Linux режим обоев пока не поддерживается; меню настроек и визуализатор работают.
