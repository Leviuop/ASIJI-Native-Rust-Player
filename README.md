...
[Руководство](docs/GUIDE.md) · [Визуализатор](docs/VISUALIZER.md) ·
...
| Debian 12+ / Ubuntu 22.04+ | `asiji_0.8.0_amd64.deb` | `sudo apt install ./asiji_0.8.0_amd64.deb` → `asiji` |
...
В меню нажмите **S**, вводите по одной строке, затем **W** для сохранения:
