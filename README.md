...
| Debian 12+ / Ubuntu 22.04+ | `asiji_0.9.1_amd64.deb` | `sudo apt install ./asiji_0.9.1_amd64.deb` → `asiji` |
...
- **Живые обои:** Windows Explorer, Plasma, GNOME, layer-shell и X11 с дополнительными компонентами (экспериментально).
